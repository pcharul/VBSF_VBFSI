function [mre_err,rmse_err] = vbsf_run(data,p,start_day,end_day,rank,r)
...
r=r1;
    ...
    Yi=Y;
        ...
        J=zeros(r,r); Sigma_J=eye(r,r);
         ...
         [Xiest,A,Sigma_A, B_1, Sigma_B_diag_1, J ,Sigma_J,wb_1,r]=vbsf(Yi,Pi,A,Sigma_A,B,Sigma0,mu0,J,Sigma_J);
